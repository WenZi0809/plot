...
TADSource = os.path.join(TADFolder, 'mESC-HindIII-20K-40K.txt')
HiCData = np.load(HiCSource)
TADData = analyze.TAD(TADSource).data
chrom = ['1']
interval = 50
# Output Figure Name
oPrefix = 'mESC-Heatmaps-1k_Signals-mm10_motif'
#--------------------------------------------------------------------------
# One-dimensional Tracks
sigFolder = '/public/home/3dgenome/wenzi/mm10/npy-1k'
Sigs =  ['CTCF','CTCF_motif-','CTCF_motif+','Med12','Med12_motif-','Med12_motif+','CapD3','CapD3_motif-','CapD3_motif+','Smc1']

...
#--------------------------------------------------------------------------
# Hi-C Related ...
HiCFolder = '/public/home/3dgenome/wenzi/mm10/gm12878'
TADFolder = '/public/home/3dgenome/wenzi/mm10'
...
TADSource = os.path.join(TADFolder, 'GM12878-MboI-10K-40K.txt')
HiCData = np.load(HiCSource)
TADData = analyze.TAD(TADSource).data
chrom = ['1']
interval = 50
# Output Figure Name
oPrefix = 'Gm12878-Heatmaps-1k_top15k-TF-Signals'
#--------------------------------------------------------------------------
# One-dimensional Tracks
sigFolder = '/public/home/3dgenome/wenzi/mm10/gm12878/npy'
#Sigs =  ['Ctcf','Rad21','Znf143', 'Znf384', 'Yy1', 'Cmyc', 'Max', 'Mxi1', 'Hcfc1', 'Cux1']
Sigs = ['Ctcf', 'Ctcf-20k','Cux1','Cux1-20k','Spl1','Spl1-15k','Yy1','Yy1-15k','Znf143','Znf143-10k']
ResSig = 20000
step = ResHiC * interval / ResSig
fold = 20000
database = {}
for s in Sigs:
    desFil = 'Gm12878' + '_' + s + '.npy'
...
#        Matrix = np.ma.array(Matrix, mask = Bool)
        ...
        for name in Sigs:
            sig = current[name][startSig*20:EndSig*20]
